Pod::Spec.new do |spec|
  ...
  spec.description  = <<-DESC
                   ...
                   * Compile time checks and errors instead of runtime crashes
                   DESC
  spec.homepage     = "https://github.com/icerockdev/R.swift"
  ...
  spec.source = { :http => "https://github.com/icerockdev/R.swift/releases/download/v#{spec.version}/rswift-#{spec.version}.zip" }
